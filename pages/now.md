...
What I'm focused on right now. ([What's a /now page?](https://nownownow.com/about))
...
Since one of the widely used tools at JGI is [`BBTools`](https://bbmap.org/) is written in Java and much of my initial work has focused on developing CI testing for it, I feel it is useful for learning.
